...
describe("GET /companies", function () {
  ...
  //testing filter for name
  test("filter test for name", async function() {
  ...
  //testing filter for minEmployees
  test("filter test for maxEmloyees", async function() {
  ...
  //testing filter for maxEmployees
  test("filter test for minEmloyees", async function() {
  ...
  test("test when minEmployees is greater than maxEmployees", async function() {
  ...
  test("invalid filter request", async function() {
    const resp = await request(app).get("/companies").query({testFilter: 0});
    expect(resp.statusCode).toEqual(400);
  })
  ...
  test("works for anon", async function () {
    ...
    expect(resp.body).toEqual({
      company: {
        ...
        logoUrl: "http://c1.img",
        jobs: [
          {id: testJobIds[0], title:"job_c1", salary: 100, equity: "0"}
        ]
      },
    });
  });
  ...
  test("works for anon: company w/o jobs", async function () {
    ...
    expect(resp.body).toEqual({
      company: {
        ...
        logoUrl: "http://c2.img",
        jobs: [
          {id: testJobIds[1], title:"job_c2", salary: 1000, equity: "1"}
        ]
      },
    });
  });
